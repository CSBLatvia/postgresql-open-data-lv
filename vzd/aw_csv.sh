...
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_ciems_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_ciems_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_dziv RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_dziv (kods, tips_cd, statuss, apstipr, apst_pak, vkur_cd, vkur_tips, nosaukums, sort_nos, atrib, dat_sak, dat_mod, dat_beig, std) FROM aw_dziv.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_dziv_his RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_dziv_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_dziv_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_eka RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_eka (kods, tips_cd, statuss, apstipr, apst_pak, vkur_cd, vkur_tips, nosaukums, sort_nos, atrib, pnod_cd, dat_sak, dat_mod, dat_beig, for_build, plan_adr, std, koord_x, koord_y, dd_n, dd_e) FROM aw_eka.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_eka_his RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_eka_his (kods, kods_his, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_eka_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_iela RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_iela (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_iela.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_iela_his RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_iela_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_iela_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_novads RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_novads (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_novads.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_novads_his RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_novads_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_novads_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_pagasts RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_pagasts (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_pagasts.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_pagasts_his RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_pagasts_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_pagasts_his.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
psql -U scheduler -d spatial -w -c "TRUNCATE TABLE aw_csv.aw_pilseta RESTART IDENTITY;"
psql -U scheduler -d spatial -w -c "\COPY aw_csv.aw_pilseta (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_pilseta.csv WITH (FORMAT CSV, QUOTE '\"', ESCAPE '\"', HEADER, FORCE_NULL *)"
